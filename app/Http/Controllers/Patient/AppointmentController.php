...
class AppointmentController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'date'      => ['required', 'date_format:Y-m-d', 'after_or_equal:today', 'before:' . now()->addMonths(3)->format('Y-m-d')],
            'time'      => ['required', 'in:08:00,08:30,09:00,09:30,10:00,10:30,11:00,11:30,13:00,13:30,14:00,14:30,15:00,15:30,16:00'],
