    ...
    <div class="min-h-screen bg-slate-200 py-6">
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden" style="height: 75vh;">
                ...
                {{-- En móvil: solo lista. En desktop: dos columnas --}}
                <div class="flex h-full">

                    {{-- Lista de conversaciones --}}
                    <div class="w-full md:w-80 border-r border-slate-200 flex flex-col flex-shrink-0">
                    ...
                    {{-- Panel vacío — solo visible en desktop --}}
