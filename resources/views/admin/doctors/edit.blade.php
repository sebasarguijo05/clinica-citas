...
<div class="max-w-2xl mx-auto">
    <h1 class="text-2xl font-bold text-gray-800 mb-6">✏️ Editar Doctor</h1>
        ...
        <form method="POST" action="{{ route('admin.doctors.update', $doctor) }}">
            ...
            <div class="mb-4">
                ...
                <textarea name="bio" rows="3"
                    class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('bio', $doctor->bio) }}</textarea>
            </div>

            <div class="mb-6 flex items-center gap-2">
                <input type="checkbox" name="active" id="active"
                    {{ $doctor->active ? 'checked' : '' }} class="rounded">
