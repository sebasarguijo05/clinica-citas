...
@section('content')
<div class="bg-white rounded-xl shadow-sm overflow-hidden" style="height: 78vh;">
    <div class="flex h-full">
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <div class="px-4 py-3 border-b border-slate-200 bg-slate-50 flex items-center gap-3">
                ...
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-semibold text-slate-800 truncate">{{ $appointment->user->name }}</p>
