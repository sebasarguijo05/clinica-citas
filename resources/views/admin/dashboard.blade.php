...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            <h3 class="font-semibold text-gray-800 mb-3">🗓️ Google Calendar</h3>
            @if(auth()->user()->google_token)
                <div class="flex items-center gap-2 text-green-600 text-sm">
                    <span class="w-2 h-2 bg-green-500 rounded-full inline-block"></span>
                    Conectado
                </div>
                <p class="text-xs text-gray-400 mt-1">Los eventos se crean automáticamente al aprobar citas.</p>
            @else
                <p class="text-gray-500 text-sm mb-3">Conecta para crear eventos automáticamente.</p>
                <a href="{{ route('google.auth') }}"
                   class="inline-flex items-center gap-2 border border-gray-300 text-gray-700 px-3 py-2 rounded-lg text-sm hover:bg-gray-50 transition">
